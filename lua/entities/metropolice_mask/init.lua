...
include( "shared.lua" )
	...
	function ENT:Use(activator,caller)
		...
		if activator.IsCop then self:Remove() return end
		...
		if not activator:HasWeapon("weapon_pistol") then activator:Give("weapon_pistol") activator["MPMask"].HadPistol = false end
		if activator:HasWeapon("weapon_crowbar") then activator:StripWeapon("weapon_crowbar") activator["MPMask"].HadCrowbar = true end
