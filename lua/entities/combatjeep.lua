...
ENT.PrintName = "[Vehicle] Combat Jeep Single"
ENT.Category        = "Silvernine Vehicle"
ENT.Author            = "Silvernine"
ENT.Information        = "Armed Weapon : \n [.50 Cal Machinegun] Inf/Inf \n [5.56MM M249] Inf/Inf" 
...
function ENT:Think( )
    if ( SERVER ) then
        ...
        timer.Create("FUK_KYU_S_HOL" --[[excuse me, what the fuck?]]..self.Entity:EntIndex(), 0.01, 50, function()
